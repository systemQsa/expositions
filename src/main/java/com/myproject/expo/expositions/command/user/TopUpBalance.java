...
public class TopUpBalance implements Command, UtilMethods {
    private static final Logger logger = LogManager.getLogger(TopUpBalance.class);
    ...
    public TopUpBalance(UserService userService, ServiceFactory serviceFactory) {
